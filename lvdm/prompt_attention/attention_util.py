...
import lvdm.prompt_attention.ptp_utils as ptp_utils
import lvdm.prompt_attention.seq_aligner as seq_aligner
from lvdm.prompt_attention.spatial_blend import SpatialBlender
from lvdm.prompt_attention.visualization import show_cross_attention, show_self_attention_comp
from lvdm.prompt_attention.attention_store import AttentionStore, AttentionControl
from lvdm.prompt_attention.attention_register import register_attention_control
...
class EmptyControl:
    ...
    def __call__(self, attn, is_cross: bool, place_in_unet: str, store_x):
        return attn
...
class AttentionControlEdit(AttentionStore, abc.ABC):
    ...
    def forward(self, attn, is_cross: bool, place_in_unet: str, store_x):
        super(AttentionControlEdit, self).forward(attn, is_cross, place_in_unet, store_x)
