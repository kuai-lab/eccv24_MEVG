...
class DDPM(pl.LightningModule):
    ...
    def add_noise(self, original_samples: torch.FloatTensor, 
                  noise: torch.FloatTensor, timesteps: torch.IntTensor,) -> torch.FloatTensor:
...
class LatentDiffusion(DDPM):
    ...
    def apply_model(self, x_noisy, t, cond, prev_attn_map = None, **kwargs):
        if isinstance(cond, dict): # lvdm -> dict
            ...
            cond = {key: cond}
        x_recon = self.model(x_noisy, t, attn_map=prev_attn_map, **cond, **kwargs)
...
class DiffusionWrapper(pl.LightningModule):
    ...
    def forward(self, x, t, c_concat: list = None, c_crossattn: list = None,
        ...
        elif self.conditioning_key == 'crossattn': # lvdm -> crossattn
